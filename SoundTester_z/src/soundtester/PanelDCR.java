...
/**
 * Panel do realizacji testu DCR i CCR.
 */
public class PanelDCR extends javax.swing.JPanel {
    ...
    /**
     * Akcja następująca po zaznaczeniu wiersza tabeli. Pobiera dane z zaznaczonego wiersza modelu tabeli i wstawia je do odpowiednich kontrolek w panelu edycji.
     */
    ...
    private void play(String path) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Uwaga! Błąd przy odtwarzaniu próbki", null, JOptionPane.ERROR_MESSAGE);
        }
    }
...
/**
 * Wybór wiersza z próbką przez użytkownika. Sterowanie przy użyciu klawiatury.
 * @param evt Zdarzenie.
 */
...
/**
 * Akcja kliknięcia przycisku dzięki której odtwarzana jest próbka wzorcowa z wybranego wiersza tabeli.
 * @param evt Zdarzenie.
 */
...
/**
 * Akcja kliknięcia przycisku zatwierdzającego ocenę osoby testującej. Po niej następuje zapis wyniku oceny do modelu tabeli.
 * Sprawdza czy próbka została przetestowana przez wszystkich testerów. Jeśli nie, to przechodzi do następnego testera.
 * Jeśli tak, to sprawdza, czy są jeszcze nieprzetestowane próbki, jeśli tak, to ustawia zaznaczenie kolejnego wiersza tabeli, jeśli nie, to wyświetla odpowiedni komunikat.
 * @param evt Zdarzenie.
 */
...
/**
 * Akcja kliknięcia przycisku zapisu wyników. Pobieranie z modelu tabeli danych w postaci ciągu znaków oddzielonych średnikami (.CSV).
 * @param evt Zdarzenie.
 */
...
/**
 * Akcja kliknięcia przycisku po której następuje odtworzenie próbki testowej z wybranego wiersza tabeli.
 * @param evt Zdarzenie.
 */
